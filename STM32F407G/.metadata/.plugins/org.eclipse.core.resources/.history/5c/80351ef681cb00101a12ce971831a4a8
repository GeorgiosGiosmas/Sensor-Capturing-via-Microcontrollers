...
TaskHandle_t xTaskHeatSensor, xTaskPotensiometerValue, xTaskTransmitHeatSensor, xTaskTransmitPotensiometerValue = { 0 };
BaseType_t taskStatus = 0;
SemaphoreHandle_t xTransmitSemaphore, xUARTSemaphore, xPotensiometer_i2c, xTemp_sensor_i2c = { 0 };
